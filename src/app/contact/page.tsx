        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <div className="space-y-3 text-navy/75">
              <p className="flex items-center gap-3"><Mail className="w-5 h-5 text-gold" strokeWidth={1.5} /> <a href="mailto:hello@yegdate.ca" className="hover:text-gold transition-colors">hello@yegdate.ca</a></p>
