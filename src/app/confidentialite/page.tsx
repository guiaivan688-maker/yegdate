...
export default function ConfidentialitePage() {
  ...
  const sections = fr
    ? [
        ["Qui sommes-nous", "Where To Go YEG est une plateforme indépendante de planification d'expériences à Edmonton (Alberta, Canada). Pour toute question : hello@wheretogoyeg.ca."],
        ...
        ["Vos droits", "Vous pouvez demander l'accès, la correction ou la suppression de vos données à tout moment en écrivant à hello@wheretogoyeg.ca."],
      ]
    : [
        ["Who we are", "Where To Go YEG is an independent experience-planning platform in Edmonton (Alberta, Canada). Questions: hello@wheretogoyeg.ca."],
        ...
        ["Your rights", "You may request access, correction or deletion of your data anytime by emailing hello@wheretogoyeg.ca."],
      ];
